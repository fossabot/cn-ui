...
export function getPrettyFuncIdentifier(
	identifier: string,
...
export function getPrettyIdentifier(
	inferredType: InspectionIdentifiableInferedType,
): string {
	...
	switch (type) {
		case InspectionType.FUNCTION:
			...
			return getPrettyFuncIdentifier(
				identifier,
				(inferredType as InspectionFunction).hasParams,
			);
