...
): ParsingResult<InspectionIdentifier> {
	return {
		inferredType: {
...
): ParsingResult<InspectionLiteral> {
	return {
...
function parseFunction(
	...
	const identifierName = extractIdentifierName(
		(funcNode as estree.FunctionExpression).id,
	);
...
function parseJsxElement(
	jsxElementNode: any,
): ParsingResult<InspectionElement> {
...
): ParsingResult<InspectionObject> | null {
...
): ParsingResult<InspectionObject> {
	return {
		inferredType: {
...
function parseExpression(
	expression: any,
): ParsingResult<InspectionInferedType> | null {
