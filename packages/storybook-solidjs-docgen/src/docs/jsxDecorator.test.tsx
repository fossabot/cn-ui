...
import { jsxDecorator, renderJsx } from "./jsxDecorator";
...
describe("renderJsx", () => {
	...
	it("functions", () => {
		...
		expect(
			renderJsx(<div onClick={onClick}>hello</div>, {}),
	...
	it("undefined values", () => {
		expect(
			renderJsx(<div className={undefined}>hello</div>, {}),
		).toMatchInlineSnapshot(`
      <div>
        hello
      </div>
	...
	it("forwardRef component", () => {
		const MyExoticComponent = React.forwardRef<PropsWithChildren<any>>(
		...
		expect(
			renderJsx(createElement(MyExoticComponent, {}, "I am forwardRef!"), {}),
		).toMatchInlineSnapshot(`
      <MyExoticComponent>
        I am forwardRef!
      </MyExoticComponent>
	...
	it("memo component", () => {
		...
		expect(
			renderJsx(createElement(MyMemoComponent, {}, "I am memo!"), {}),
		).toMatchInlineSnapshot(`
      <MyMemoComponent>
        I am memo!
      </MyMemoComponent>
	...
	it("Profiler", () => {
		...
		expect(
			renderJsx(createElement(ProfilerComponent, {}, "I am Profiler"), {}),
		).toMatchInlineSnapshot(`
        <ProfilerComponent>
          I am Profiler
        </ProfilerComponent>
	...
	it("should not add default props to string if the prop value has not changed", () => {
		...
		expect(
			renderJsx(<Container>yo dude</Container>, {}),
		).toMatchInlineSnapshot(`
