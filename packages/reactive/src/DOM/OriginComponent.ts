...
export type OriginComponentInputType<
	T,
	RefType = HTMLElement,
	ModelType = string,
> = Omit<JSX.HTMLAttributes<RefType>, "style" | "class" | "children"> & // 对内的类型注解
	Omit<T, "style" | "class"> & {
		id?: string;
		ref?: (el: RefType) => void;
...
export type OriginComponentOutputType<
	T,
	RefType = HTMLElement,
	ModelType = string,
> = Omit<JSX.HTMLAttributes<RefType>, "style" | "class" | "children"> & // 对外的类型注解
	Omit<T, "style" | "class"> & {
		ref?: (el: RefType) => void;
		style?: JSX.CSSProperties;
