...
import typescriptReactTM from '@opensumi/textmate-languages/es/typescript/syntaxes/TypeScriptReact.tmLanguage.json'
import cssTM from '@opensumi/textmate-languages/es/css/syntaxes/css.tmLanguage.json'
