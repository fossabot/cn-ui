...
export type CheckboxGroupCtxType = ReturnType<
	typeof useSelect<SelectOptionsType>
>;
export const CheckboxGroupCtx = /* @__PURE__ */ createCtx<CheckboxGroupCtxType>(
	{} as any,
);
...
export const Checkbox = OriginComponent<
	CheckboxProps,
	HTMLInputElement,
	boolean
>((props) => {
	...
	const inputType = computed(() =>
		group?.multi?.() === false ? "radio" : "checkbox",
	);
	...
	const inputClass = useMapper(inputType, {
		radio() {
			...
			return ["border-design-border", "border-primary-500"].map(
				(i) => base + i,
			);
		},
		checkbox() {
