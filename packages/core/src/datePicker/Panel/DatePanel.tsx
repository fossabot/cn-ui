import { DatePicker, type DatePickerContext, useDatePickerContext } from "@ark-ui/solid";
...
export const tableCellClasss =
    "transition-colors duration-300 text-center hover:bg-design-hover rounded";
