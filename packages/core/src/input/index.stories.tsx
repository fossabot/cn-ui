...
export const Password: Story = {
    ...
    render() {
        ...
        return (
            <div class="flex gap-4">
                <BaseInput v-model={data} type="password" suffixIcon={PasswordControl} />
                <BaseInput v-model={data} type="password" disabled suffixIcon={PasswordControl} />
            </div>
        );
    },
    args: {},
...
export const Textarea: Story = {
    ...
    render() {
        const data = atom("123232");
        const inputExpose = NullAtom<InputExpose>(null);
        return <BaseInput auto-size v-model={data} type="textarea" expose={inputExpose} />;
    },
    args: {},
};
