...
export const BaseInput = OriginComponent<
	BaseInputProps,
	HTMLInputElement,
	string
>((props) => {
	...
	const Prefix = computed(() => {
		...
		return (
			<Show when={child}>{<span class="mr-1 flex-none">{child}</span>}</Show>
		);
	});
	...
	return (
		<span
			...
			class={props.class(
				...
				props.disabled &&
					"border-design-border bg-gray-100 text-gray-400 opacity-50",
