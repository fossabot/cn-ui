import { Atom, DateCalendarConfig, JSXSlot, OriginComponent, computed, atom, createCtx, useCalendarSelect, useDateCalendar } from '@cn-ui/reactive'
...
export const Calendar = OriginComponent<CalendarProps, HTMLTableElement, Dayjs[]>((props) => {
    ...
    const select = useCalendarSelect(selected, { mode: () => props.mode ?? 'single', unit: calendarType })
            ...
            <div class="flex flex-col select-none w-fit min-w-[15rem]">
                ...
                <Switch>
                    ...
                    <Match when={calendarShowingType() === 'day'}>
                        <DateCalendarPanel Cell={props.Cell}></DateCalendarPanel>
                    </Match>
                </Switch>
            </div>
