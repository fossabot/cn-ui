...
export const TOCHeading = (props: { heading: TOCHeadingType }) => {
    ...
    return (
        <li class={classNames(depth(), 'text-nowrap text-ellipsis overflow-hidden hover:opacity-100 transition-opacity')}>
...
export const TOC = OriginComponent<{ headings: TOCHeadingType[] }>((props) => {
    return (
        <nav class={props.class(props, 'opacity-70 hover:opacity-50 transition-opacity')} style={{ ...props.style() }} ref={props.ref}>
            <ul>
                {props.headings
